...
struct DateFormatter
{
    ...
    { (ushort)0U, (ushort)31U, (ushort)59U, (ushort)90U, (ushort)120U, (ushort)151U, (ushort)181U, (ushort)212U,
      (ushort)243U, (ushort)273U, (ushort)304U, (ushort)334U, (ushort)365U, };
    private static readonly ushort[] _daysToMonth366 =
    { (ushort)0U, (ushort)31U, (ushort)60U, (ushort)91U, (ushort)121U, (ushort)152U, (ushort)182U, (ushort)213U,
      (ushort)244U, (ushort)274U, (ushort)305U, (ushort)335U, (ushort)366U, };
    ...
    internal unsafe void WriteDateAndTime(char* dest) {
        ...
        DateFormatter.WriteDate(dest, ticks);
        dest[10] = ' ';
        DateFormatter.WriteTime(dest + 11, ticks);
    }
    ...
    private ulong ComputeCurrentDate() {
        ...
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Linux) || RuntimeInformation.IsOSPlatform(OSPlatform.OSX)
            ...
            ticks = (ulong)DateFormatter.UnixGetSystemTimeAsTicks() + _utcLocaleDiff;
        } else if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows)) {
            ticks = DateFormatter.WindowsGetSystemTimeAsTicks() + _utcLocaleDiff;
        } else {
    ...
    /// <summary>
    ///     Write all date element without repeating call. Adapted from .net6 implementation of DateTime properties: Day,
    ///     Year, and Month of date time
    /// </summary>
    ...
    private static unsafe void WriteDate(char* dest, ulong ticks) {
        ...
        ushort[] numArray = num8 != 3U || (num6 == 24U && num4 != 3U)
                ? DateFormatter._daysToMonth365
                : DateFormatter._daysToMonth366;
...
#pragma warning restore CS0649
    ...
    private static ulong WindowsGetSystemTimeAsTicks() {
        ...
        DateFormatter.GetSystemTimeAsFileTime(ref fileTime);
